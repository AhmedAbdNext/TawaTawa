const Snackbar = ({ type,message}: ISnackbar) => {
    return (
        ...
        <div className={`flex items-center rounded shadow-md overflow-hidden w-full relative dark:bg-gray-900 dark:text-gray-100 
        ${type === "success" ? "bg-green-500" : "bg-red-500"} ${type === "success" ? "text-green-100" : "text-red-100"} `}>
